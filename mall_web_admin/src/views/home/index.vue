      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-value">￥3786.00</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="total-frame">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              ...
              <span style="float: right" class="color-danger">(11)</span>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="20">
        ...
        <el-col :span="12">
          <div class="out-border">
            ...
            <div style="padding: 40px">
              <el-row>
                <el-col :span="6" class="color-danger overview-item-value">0</el-col>
        ...
        <el-col :span="4">
          <div style="padding: 20px">
            <div>
              ...
              <div style="color: #606266;font-size: 24px;padding: 10px 0">19</div>
              <div>
            ...
            <div style="margin-top: 20px;">
              ...
              <div style="color: #606266;font-size: 24px;padding: 10px 0">7</div>
              <div>
            ...
            <div style="margin-top: 20px;">
              ...
              <div style="color: #606266;font-size: 24px;padding: 10px 0">3786</div>
              <div>
                <span class="color-success" style="font-size: 14px">+10%</span>
                <span style="color: #C0C4CC;font-size: 14px">同比上月</span>
              </div>
